        ...
        xl:pt-8 xl:pb-24">
          ...
          <div className="text-center xl:text-left order-2 xl:order-none ">
            ...
            <h1 className="h1 mb-6">
              Hello I'm <br /> <span className="text-accent">Kona Shankar</span>
            </h1>
            <p className="max-w-[500px] mb-9 text-white/80">I excel at crafting elegent digital experiences and I am proficient in
